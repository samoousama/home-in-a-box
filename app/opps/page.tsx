...
export default function Opps() {
  return (
    <div className="min-h-screen">
      ...
      <div className="py-[40px] text-center flex flex-col gap-[30px]">
        ...
        <div className="max-w-[650px] m-auto">
          <p className="text-[16px] leading-[24px] text-[#3E3636]">Enter your email and we will notify you as soon as we restock.. with a discount for the inconvenience!</p>
        </div>
      </div>

      <div className="max-w-[785px] sm:w-full m-auto rounded-[10px] overflow-hidden mt-[50px] shadow-2xl shadow-[#5C94FF45] bg-gradient-to-t from-[#FFFAC5] to-[#FFFAC5] p-[2px] rounded-[12px]">
